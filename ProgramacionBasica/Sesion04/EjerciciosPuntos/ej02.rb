...
def calcularTotalPagar(tipo,cantidad)
    if (cantidad == 0)
        ...
        suscripcion = calcularPrecioSuscripcion(tipo)
        desc = calcularDescuentoCantidad(cantidad)
        monto = suscripcion*cantidad*(1-desc)
        return monto
    end
end
...
def test
  ...
  puts "---------------------------"
  puts calcularTotalPagar("Vamos",0)
  puts calcularTotalPagar("Cosas",12)
  puts calcularTotalPagar("Automas",90)
  puts calcularTotalPagar("Construye",101)
  puts calcularTotalPagar("Vamos",210)
  puts " "
end
