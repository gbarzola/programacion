...
def monto_ganado(tipo_trabajador, monto_ventas)
	return bono_sobre_ventas(tipo_trabajador, monto_ventas)*monto_ventas
end

def sueldo_total(tipo_trabajador, monto_ventas, sueldo_base)
	return monto_ganado(tipo_trabajador, monto_ventas) + sueldo_base
end
# #--- zona de test ----
...
def test
  ...
  puts "---------------------------"
     puts sueldo_total("Plata",300,1000.0)
     puts sueldo_total("Oro",5096, 3000.0)    
     puts sueldo_total("Oro",87,4500.0)
     puts sueldo_total("Platino",5500, 2000)
  puts " "
end
test
